        ...
        <li>
            ...
            <ul>
                <li>
                    ...
                    <img src="./img/schematicImages/import-project-clip.png" alt="Import Project Clip" width="600px" class="joint">
                </li>
                <li>
                    ...
                    <img src="./img/schematicImages/seleccion-macro-arduino.png" alt="seleccion de Arduino UNO 328" width="600px" class="joint">
                </li>
                <li>
                    ...
                    </p><img src="./img/schematicImages/snippet-proteus.gif" alt="seleccion de Arduino UNO 328">                    
                </li>
            </ul>
        </li>
        <li>
            ...
            <ul>
                <li>
                    ...
                    <img class="joint" src="./img/schematicImages/abre-libreria.png" alt="pantalla de inicio" width="600px" />
                </li>
                <li>
                    ...
                    <img class="joint" src="./img/schematicImages/libreria-componentes.png" alt="ventana de librería" width="600px" />
            ...
            <ul>
                <li>
                    ...
                    <p>Seguidamente damos click en cualquier lugar de nuestro espacio de trabajo. Una sombra de nuestro componente estará asociada al cursor del mouse, lo cual queremos aprovechar 
                        ...
                        <img src="./img/schematicImages/put-component.gif" alt="selección desde la lista de dispositivos">
                ...
                <li>
                    ...
                    <img class="joint" src="./img/schematicImages/VID-20230419-WA0027.gif" alt="conexión entre componentes" width="600px">
                </li>
            </ul>
        </li>
        <li>
            ...
            <ul>
                <li>
                    ...
                    <img src="./img/schematicImages/motor-driver.png" alt="Motor Driver L298">
                </li>
        ...
        <li>
            ...
            <ul>
                <li>
                    ...
                    <img src="./img/schematicImages/conectors.png" alt="Conectores Usados">
                </li>
                ...
                <li>
                    ...
                    <img src="./img/schematicImages/etiquetado-cables.gif" alt="Etiquetado de cables">
                </li>
            </ul>
        </li>
